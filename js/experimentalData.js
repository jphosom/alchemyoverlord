...
var trainingData = {
    "Tinseth": {
        ...
        //                AA%   BA%   form    freshF  %loss  weight(g),  min after 1st hops addition
        "add1":        [ 8.65,  6.18, "cones", 0.95,   38.2,  283.495,   0 ],
			  "boilTime":    90,
    ...
    "Peacock": {
        ...
        "OG_list":     [ 1.035,       1.035,      1.035,      1.035 ],
			  ...
			  // Willamette hops
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 3.90,  2.89, "cones", 0.83,   37.43,  425.0,     0 ],
			  "boilTime":    90,
    ...
    "mIBU Exp. #1": {
        ...
        //                         AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":                 [ 8.00,  6.6,  "cones", 0.72,   50.0,  17.01,     0 ],
 
			  "realBoilTime":         60.0,  // *all* conditions used a boil time of 60 min
    ...
    "mIBU Exp. #2a": {
        ...
        //                        AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":                 [ 8.40,  3.5, "cones", 0.68, 50.0,  45.36,     0 ],
    ...
    "mIBU Exp. #2b": {
        ...
        //                         AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":                 [ 7.90,  6.32, "cones", 0.79,  50.0,  45.36,     0 ],
    ...
    "mIBU Exp. #3": {
        ...
        //                        AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":                 [ 6.64,  5.38, "cones", 0.95,  50.0,  22.68,     0 ],
    ...
    "Util. Exp. #1": {
        ...
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 8.10,  7.60, "cones", 0.95,  50.0,   21.26,     0 ],
    ...
    "Util. Exp. #3": {
        ...
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 8.10,  7.60, "cones", 1.00,  50.0,  0.0,     0 ],
    ...
    "Util. Exp. #4": {
        ...
        "postBoil_temp_list":   [ 0.0,     0.0,     0.0,     0.0,     63.61 ],
			  ...
			  // cascade package rating AA=8.10%, BA=7.60%.  Measured AA=7.7%, BA=6.8%, HSI 0.231
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 8.10,  7.60, "cones", 0.94,  50.0,  0.0,     0 ],
			  ...
			  "tempDecayType":        "tempDecayExponential", 
		    "whirlpoolTime":        0,
			  "holdTempCheckbox":     false,
			  "holdTemp":             373.15, // boiling
		    "immersionDecayFactor": 0.87,
			  "counterflowRate":      0.00,
    ...
    "Sol. Exp. #2": {
        ...
        "OG_list":              [ 1.0493,  1.0496,  1.0499,  1.0502,  1.0505,
			  ...
			  // default freshness factor 0.58 is rough guess based on IBU results
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 13.30,  3.90, "cones", 0.58,  25.0,  82.865,    0 ],
    ...
    "Sol. Exp. #3": {
        ...
        "OG_list":              [ 1.0486,  1.0491,  1.0495,  1.0499,  1.0503,
			  ...
			  // default freshness factor 0.58 is rough guess based on IBU results
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 13.30,  3.90, "cones", 0.58,  25.0,  177.1845,   0 ],
    ...
    "Sol. Exp. #4": {
        ...
        "OG_list":              [ 1.0480,  1.0484,  1.0489,  1.0493,  1.0498,
			  ...
			  // default freshness factor 0.58 is rough guess based on IBU results
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 13.30,  3.90, "cones", 0.58,  25.0,  120.4855,   0 ],
    ...
    "ConPel Exp. #1": {
        ...
        "time_list":            [ 10.0,    20.0,    30.0,    40.0,    50.0,
			                            60.0,    70.0,    80.0,    90.0 ],
        "volume_list":          [ 31.358,  31.354,  31.351,  31.347,  31.343,
					                        31.343,  31.339,  31.336,  31.332 ],
        "OG_list":              [ 1.0388,  1.0389,  1.0390,  1.0391,  1.0392,
			                            1.0393,  1.0394,  1.0395,  1.0396 ],

			  // citra bought soon after harvest and stored in freezer; package rating AA=14.30%
			// JPH CHECK BA!!
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 14.30,  3.5, "cones", 0.95,  25.0,  37.8098,   0 ],
 
			  "timeToFirstAddition":  8,      // wait 8 minutes after start of boil
			  "boilTime":             90,
			  "evaporationRate":      0.0195, // (V10=31.358 - V90=31.332) / (80min/60min)
		    "whirlpoolTime":        0,
		    "immersionDecayFactor": 10.0,
			  "pH":                   "estimate",
			  "preBoilSG":            1.0384,
    ...
    "ConPel Exp. #2": {
        ...
        "volume_list":          [ 31.358,  31.354,  31.351,  31.347,  31.343, 31.343 ],
        "OG_list":              [ 1.0388,  1.0389,  1.0390,  1.0391,  1.0392, 1.0393 ],

			  // willamette package rating AA 5.0%
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 5.00,  3.10, "cones", 0.95,  37.43,  105.573,   0 ],
 
			  "timeToFirstAddition":  4,      // wait 4 minutes after start of boil
			  "boilTime":             60,
			  "evaporationRate":      0.0180, // (V10=31.358 - V60=31.343) / (50min/60min)
		    "whirlpoolTime":        0,
		    "immersionDecayFactor": 10.0,
			  "pH":                   "estimate",
			  "preBoilSG":            1.0383,
    ...
    "ConPel Exp. #3": {
        ...
        "volume_list":          [ 31.36,   31.35,   31.35,   31.35,   31.34,   31.34,   31.34,   31.34 ],
        "OG_list":              [ 1.0388,  1.0389,  1.0390,  1.0391,  1.0392,  1.0393,  1.0394,  1.0395 ],
        ...
        "add1":        [ 5.00,  3.10, "cones", 0.95,  37.43,  105.573,   0 ],
			  ...
			  "timeToFirstAddition":  5,      // wait 5 minutes after start of boil
			  "boilTime":             80,
			  "evaporationRate":      0.0171, // (V10=31.36 - V80=31.34) / (70min/60min)
		    "whirlpoolTime":        0,
		    "immersionDecayFactor": 10.0,
			  "pH":                   "estimate",
			  "preBoilSG":            1.039,
    ...
    "ConPel Exp. #4": {
        ...
        "time_list":            [ 10.0,    20.0,    30.0,    40.0,    50.0,    60.0,    70.0,    80.0 ],
        "volume_list":          [ 31.80,   31.79,   31.79,   31.79,   31.78,   31.78,   31.78,   31.77 ],
        "OG_list":              [ 1.0392,  1.0393,  1.0394,  1.0395,  1.03965, 1.0398,  1.0399,  1.0340 ],

			  // comet package rating AA 10.0%; analysis = AA=10.80%, BA=3.92%, HSI=0.25
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 10.00,  3.92, "cones", 1.0,  37.43,  53.312,   0 ],
		    ...
		    "immersionDecayFactor": 10.0,
			  "pH":                   "estimate",
			  "preBoilSG":            1.036,  // new hydrometer
        "beerAge_days":         8,
    ...
    "Sol. pH 5.2": {
        ...
        "volume_list":          [ 5.678,   5.678,   5.678,   5.669,   5.678,   5.669,   5.678,   5.674,   5.678,   5.678 ],
        ...
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 14.30,  3.5, "cones", 0.95,  25.0,  0.0,   0 ],
 
			  "timeToFirstAddition":  0,      // wait 0 minutes after start of boil
			  "boilTime":             20,
			  "evaporationRate":      0.0264, // avg loss 0.0044 liters in 10 minutes * (60min/10min)
		    "whirlpoolTime":        0,
		    "immersionDecayFactor": 10.0,
			  "pH":                   5.19,
        "beerAge_days":         10,
    ...
    "Hop Concentration Exp. #1": {
        ...
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 14.30,  3.5, "cones", 0.95,  25.0,  0.0,   0 ],
        "add2":        [  5.00,  3.1, "cones", 0.95,  37.43, 0.0,   0 ],
    ...
    "pH Exp. #1": {
        ...
        "OG_list":              [ 1.0382,    1.0385,    1.0388,    1.0391,    1.0382,    1.0385,    1.0388,    1.0391,
			  ...
			  // citra bought soon after harvest and stored in freezer
        //                AA%   BA%   form    freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 14.30,  3.5, "cones", 0.965,  25.0,  18.285,   0 ],
    ...
    "CaCl2 Exp. #1": {
        ...
        "OG_list":              [ 1.03825, 1.0388,  1.0394,  1.0400,  1.03825, 1.0388,  1.0394,  1.0400,
			  ...
			  // citra bought soon after harvest and stored in freezer
        //                AA%   BA%   form     freshF  %loss  weight(g), min after 1st hops addition
        "add1":        [ 14.3,  3.5, "cones", 0.948,  25.0,  19.675,   0 ],
